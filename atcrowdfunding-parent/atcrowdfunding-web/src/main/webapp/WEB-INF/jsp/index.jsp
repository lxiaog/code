...
<head>
    ...
    <link rel="stylesheet" href="${APP_PATH}/view/css/carousel.css">
    <style>
        h3 {
            font-weight: bold;
        }
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse" style="float:right;">
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="${APP_PATH}/web/login">登录</a></li>
                        <li><a href="${APP_PATH}/web/reg">注册</a></li>
                    </ul>
                </div>
            </div>
        </nav>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active" onclick="window.location.href='project.html'" style="cursor:pointer;">
            <img src="${APP_PATH}/view/img/carousel-1.jpg" alt="First slide">
        </div>
        <div class="item" onclick="window.location.href='project.html'" style="cursor:pointer;">
            <img src="${APP_PATH}/view/img/carousel-2.jpg" alt="Second slide">
        </div>
        <div class="item" onclick="window.location.href='project.html'" style="cursor:pointer;">
            <img src="${APP_PATH}/view/img/carousel-3.jpg" alt="Third slide">
        </div>
    </div>
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/view/img/p1.jpg" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>智能高清监控机器人</h2>
            <p>可爱的造型，摄像安防远程互联的全能设计，让你随时随地守护您的家人，陪伴你的生活。</p>
            <p><a class="btn btn-default" href="${APP_PATH}/view/project.html" role="button">项目详情 &raquo;</a></p>
        </div><!-- /.col-lg-4 -->
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/view/img/p2.jpg" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>NEOKA智能手环</h2>
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="${APP_PATH}/view/img/p3.png" alt="Generic placeholder image"
                 style="width: 140px; height: 140px;">
            <h2>驱蚊扣</h2>
        ...
        <div class="row clearfix">
            <div class="col-md-12 column">
                <div class="box ui-draggable" id="mainBox">
                    <div class="mHd" style="">
                        <div class="path">
                            <a href="${APP_PATH}/view/projects.html">更多...</a>
                        </div>
                        <h3>
                            科技
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-1.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">活性富氢净水直饮机</a>
                                        </h3>
                                        <p>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-2.gif"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-3.png"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-4.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">一款精致的机械表</a>
                                        </h3>
                                        <p>
                                        <div style="float:left;"><i class="glyphicon glyphicon-screenshot"
                                                                    title="目标金额"></i> $20,000
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-5.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">活性富氢净水直饮机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-6.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">酷驰触控龙头，智享厨房黑科技</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-7.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">小熊猫鱼眼全景安防摄像机</a>
                                        </h3>
                            ...
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-8.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">一款精致的机械表</a>
                                        </h3>
                ...
                <div class="box ui-draggable" id="mainBox">
                    ...
                    <div class="mBd" style="padding-top:10px;">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="thumbnail">
                                    <img alt="300x200" src="${APP_PATH}/view/img/product-9.jpg"/>
                                    <div class="caption">
                                        <h3 class="break">
                                            <a href="${APP_PATH}/view/project.html">活性富氢净水直饮机</a>
                                        </h3>
...
<script src="${APP_PATH}/view/script/back-to-top.js"></script>
<script>
