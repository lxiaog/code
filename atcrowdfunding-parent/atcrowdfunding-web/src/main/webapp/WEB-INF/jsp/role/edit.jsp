                ...
                <div class="panel-body">
                    <form role="form">
                        <div class="form-group">
                            <label for="role-name">登陆账号</label>
                            <input type="text" class="form-control" id="role-name"
                                   value="${roleEdit.roleName}">
                        </div>
                        <button id="role-edit-btn" type="button" class="btn btn-success"><i
...
<script type="text/javascript">
    $(function () {
        ...
        $("#role-edit-btn").click(function () {
            ...
            jsonPost(app_path, url_role_edit, json, function (result) {
